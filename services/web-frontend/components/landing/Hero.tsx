    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-32 pb-20 overflow-hidden">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-6xl md:text-8xl font-bold tracking-tighter mb-6 bg-gradient-to-b from-white via-white to-white/50 bg-clip-text text-transparent leading-none"
        >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-6xl mx-auto perspective-1000"
      >
        <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-emerald-500/20 bg-zinc-900/50 backdrop-blur-xl transform-gpu" style={{ transform: 'rotateX(8deg) rotateY(0deg)' }}>
          {/* Glow Effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/20 via-blue-500/20 to-purple-500/20 rounded-3xl blur-2xl opacity-50" />
          
          {/* Browser Chrome */}
          <div className="relative bg-zinc-950/80 backdrop-blur-xl border-b border-white/10 px-4 py-3 flex items-center gap-2">
            ...
            <div className="flex-1 ml-4">
              <div className="px-4 py-1.5 bg-white/5 rounded-lg text-xs text-zinc-500 font-mono">
          ...
          {/* Dashboard Preview */}
          <div className="relative bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 p-8">
            ...
            {/* Chart Placeholder */}
            <div className="mt-6 h-64 bg-white/5 rounded-2xl border border-white/10 p-6 relative overflow-hidden">
              <div className="absolute inset-0 flex items-end justify-around p-6">
                {[40, 60, 55, 75, 65, 85, 70, 90].map((height, i) => (
                  <motion.div
                    ...
                    className="w-12 bg-gradient-to-t from-emerald-500/50 to-emerald-500 rounded-t-lg origin-bottom"
                    style={{ height: `${height}%` }}
                  />
                ))}
              </div>
